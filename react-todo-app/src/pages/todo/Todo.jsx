...
function Todo() {
  ...
  useEffect(() => {
    const onSnapshot = (todos) => setList(todos)

    const onError = (err) => alert("Error subscribing to todos: " + err.toString())
    const subscription = client.subscribeToTodos(onSnapshot, onError)
